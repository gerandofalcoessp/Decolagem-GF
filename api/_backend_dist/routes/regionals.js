...
router.get('/users', async (req, res) => {
    try {
        ...
        const requesterRole = memberData.role ?? requester.role ?? null;
        const requesterRegionalRaw = memberData.regional ?? requester.regional ?? null;
        const normalizeRegional = (r) => {
            let s = (r || '').trim();
