...
describe('AuthService', () => {
    ...
    describe('signUp', () => {
        it('deve registrar novo usuário com sucesso', async () => {
            ...
            supabaseAdmin.auth.admin.createUser.mockResolvedValue(mockResponse);
            const userData = {
                email: 'test@example.com',
                password: 'password123',
    ...
    describe('updatePassword', () => {
        it('deve atualizar senha com sucesso', async () => {
            ...
            supabase.auth.getUser.mockResolvedValue(mockGetUserResponse);
            supabase.auth.updateUser.mockResolvedValue(mockUpdateResponse);
