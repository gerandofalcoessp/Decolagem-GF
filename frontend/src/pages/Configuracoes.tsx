...
export default function Configuracoes() {
  ...
  const handleCreateGoal = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const unit = (newMeta.nome === 'Retenção Decolagem' || newMeta.nome === 'Retenção Maras') ? '%' : ((newMeta.nome === 'Pessoas Atendidas Decolagem' || newMeta.nome === 'Famílias Embarcadas Decolagem' || newMeta.nome === 'Pessoas Atendidas') ? ' pessoas' : (newMeta.nome === 'Diagnósticos Realizados' ? ' diagnósticos' : ' unidades'));
