    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">Configure e gerencie as metas do programa</p>
        </div>
        ...
        <div className="p-6">
          ...
          {metas.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-2">Nenhuma meta criada ainda</p>
              ...
              {metas.map((meta: any, index: number) => (
                ...
                >
                  <div className="flex-1 mb-3">
                    ...
                    <p className="text-sm text-gray-600">
                      Regionais:{' '}
                      {meta.regionais.length === regionaisDisponiveis.length
                        ? 'Todas'
                        : meta.regionais.join(', ')}
                    </p>
                  </div>
                    ...
                    <button
                      ...
                      onClick={() => {
                        if (confirm(`Tem certeza que deseja excluir a meta "${meta.nome}"?`)) {
                          setMetas((prev: any[]) => prev.filter((_, i) => i !== index));
                        }
                      }}
                    >
                      Excluir
